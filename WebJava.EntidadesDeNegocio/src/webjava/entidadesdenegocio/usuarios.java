...
public class usuarios {
    ...
    public usuarios(int id, int rolid, String nombre, String apellido, String login, String password, byte estatus, Date fecha, int top_aux, String confirmPassword_aux, rol rol) {
        this.id = id;
        this.rolid = rolid;
        this.nombre = nombre;
